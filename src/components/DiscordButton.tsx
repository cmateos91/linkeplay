...
export default function DiscordButton({ discordUrl, devId, sessionId }: DiscordButtonProps) {
  ...
  return (
    <button
      onClick={handleClick}
      className="w-full flex items-center justify-center gap-3 px-6 py-4 rounded-xl font-semibold text-white text-base transition-opacity hover:opacity-90 active:opacity-75"
      style={{ backgroundColor: '#5865F2' }}
    >
      <svg width="24" height="18" viewBox="0 0 24 18" fill="white" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
