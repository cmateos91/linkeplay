        ...
        >
          ...
          <header className="flex flex-col items-center text-center gap-4">
            ...
            <div className="w-full flex flex-col gap-3 mt-1">
              <FollowButton devId={dev.id} devName={dev.display_name} />

              {dev.discord_invite_url && (
                <button
                  type="button"
                  onClick={handleDiscordClick}
                  className="w-full flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-bold hover:opacity-90 active:translate-y-px"
                  style={{
                    background: '#5865F2',
                    color: '#fff',
                    fontFamily: 'var(--font-space-grotesk)',
